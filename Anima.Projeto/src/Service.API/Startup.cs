...
using Anima.Projeto.Infrastructure.Data.Persistence;
...
namespace Anima.Projeto.Service.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var key = Encoding.ASCII.GetBytes(Application.Settings.Settings.Secret);
